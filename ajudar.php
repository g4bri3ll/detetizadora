                ...
                <div class="col-lg-12">
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            Auxilio na navegacao pelo site
                        </div>
                        <!-- .panel-heading -->
                        <div class="panel-body">
                            <div class="panel-group" id="accordion">
	                            <?php 
	                            $idAcesso = $_SESSION['acesso_id'];
	                            $ajuDAO = new AjudarDAO();
	                            $arrayAjuda = $ajuDAO->ListaAjudarPeloAcesso($idAcesso);
	                            $concat = "#";
	                            $i = 0;
	                            foreach ($arrayAjuda as $ajuDAO => $ajuda){
	                            ?>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion" href="<?php echo $concat.$ajuda['id']; ?>"><?php echo $ajuda['titulo']; ?></a>
                                        </h4>
                                    </div>
                                    <?php if ($i === 0) { ?>
                                    	<div id="<?php echo $ajuda['id']; ?>" class="panel-collapse collapse in">
                                    <?php } else { ?>
                                    	<div id="<?php echo $ajuda['id']; ?>" class="panel-collapse collapse">
                                    <?php } ?>
                                        <div class="panel-body">
                                            <?php echo $ajuda['descricao']; ?>
                                        </div>
                                    </div>
                                </div>
                                <?php $i = $i + 1; } ?>
