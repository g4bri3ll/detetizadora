...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="armadilhaIscagem.php"><i class="fa fa-reply fa-fw"></i> Retorna </a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        if (!empty($_GET['mps'])){
        	...
        	$arrayFoto = $armDAO->ListaFotoMapa($idFoto);
                        ...
                        <div class="panel-body">
                           ...
                           <!-- Tab panes -->
                            <div class="row">
                            	...
                            	<div class="col-lg-11">
	                            	<a href="mapaImpresso.php?idMp=<?php echo $id; ?>"><label>Imprimir mapa</label></a> 
								</div>
							</div>
                            ...
                            <div class="row">
								<div class="col-lg-1"></div>
								<div class="col-lg-10"><img alt="" src="Img/Mapa/ArmadilhaIsca/<?php echo $foto; ?>" style="width: 100%; height: 100%;"></div>
								<div class="col-lg-1"></div>
                                <!-- /.col-lg-12 -->
                            </div>
                        </div>
