...
<head>
    ...
    <title>Lista de adquacoes</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
        	<div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header">Lista Adquacoes</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Lista todas as adquacoes do contrato
                        </div>
                        <?php 
                        //Pegar o id do cliente da session
                        $idCliente = $_SESSION['id_c'];
                        
                        $conDAO = new ContratoDAO();
                        $arrayDados = $conDAO->ListAdquacoesSim($idCliente);
                        ?>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <?php foreach ($arrayDados as $conDAO => $valor){?>
                                    <tr class="">
                                        <td><?php echo $valor['data_criacao']; ?></td>
                                        <td><?php echo $valor['descricao']; ?></td>
                                        <td><a href="fotosAdequacaoMostraCli.php?ft=<?php echo $valor['data_contrato_id']; ?>&idContrato=<?php echo $valor['contrato_id']; ?>">Visualiza</a></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
