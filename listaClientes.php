...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
         ...
         <?php 
            if (!empty($_GET['exc'])){
            	...
            	$res = $cliDAO->deleteId($id, $status);
            	
				if ($res){
					?> <script type="text/javascript"> window.location="listaClientes.php";  </script> <?php
				} else {
        ...
        <?php 
        $cliDAO = new ClienteDAO();
        $arrayCli = $cliDAO->ListaTodosOsClientes();
        ?>
        <div id="page-wrapper">
        	<div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <?php foreach ($arrayCli as $cliDAO => $valor){?>
                                    <tr class="gradeA">
                                        <td><?php echo $valor['id']; ?></td>
                                        <td><?php echo $valor['nome']; ?></td>
                                        <td><?php echo $valor['razao_social']; ?></td>
                                        <td><?php echo $valor['endereco']; ?></td>
                                        <td align="center"><a href="VisualizaClientes.php?visualizar=<?php echo $valor['id']; ?>&tipoCli=<?php echo $valor['tipo_cliente']; ?>"><i class="fa fa-check"></i></a></td>
                                        <td align="center"><a href="listaClientes.php?exc=<?php echo $valor['id']; ?>"><i class="fa fa-times"></i></a></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
