...
<head>
    ...
    <title>Alterando uma senha do colaborador</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
				...
				if (!empty($_POST)){
					...
					if (empty($_POST['senha'])){
						...
						if ($senha === $con_senha){
							...
							//Pegar os dados se eles existirem, para não dar erro na tela
							if (!empty($_POST['idFuncionario'])) { $id = $_POST['idFuncionario']; }
							if (!empty($_POST['idCliente'])) { $id = $_POST['idCliente']; }
							if (!empty($_GET['f'])) { $acesso = "funcionario"; }
							if (!empty($_GET['c'])) { $acesso = "cliente"; }
							
							$aceDAO = new AcessoSistemaDAO();
							$verificaAcesso = $aceDAO->VerificaAcesso($id, $acesso);
							
							if (!empty($verificaAcesso)){
							
								$aceDAO = new AcessoSistemaDAO();
								$result = $aceDAO->AlterarSenha($senha, $id);
								
								if ($result){
									?> <script type="text/javascript"> alert('Essa e a nova senha desse usuario!'); window.location="index.php";  </script> <?php
								} else {
									?> <div class="alert alert-error"> <font size="3px" color="#111"> Ocorreu um erro: <?php print_r($result); ?> </font> </div> <?php
								}
								
							}else {
								?> <div class="alert alert-error"> <font size="3px" color="#111"> Usuario nao possui acesso ao sistema </font> </div> <?php
							}
				...
				?>
                    <h1 class="page-header">Alterando uma senha</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="c"><br><br>
	                                ...
	                                <div class="col-lg-8">
	                                    <form role="form" action="alteraSenhaColaborador.php?c=c" method="post">
                                ...
                                <div class="tab-pane fade" id="f"><br><br>
	                                <div class="col-lg-2"></div>
	                                <div class="col-lg-8">
	                                    <form role="form" action="alteraSenhaColaborador.php?f=f" method="post">
	                                        <div class="form-group">
