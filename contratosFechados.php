...
if (!empty($_SESSION)){
	foreach ($_SESSION['nome_paginas'] as $key) {
		switch ($key) {
			case 'contratosFechados' : $as = 15;   break ;
		}
	}	
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
	                                    ...
	                                    $arrayContrato = $conDAO->ListaContratoFechados($idSession);
                                    ...
                                    <tbody>
	                                    <?php 
	                                    $conDAO = new ContratoDAO();
	                                    $arrayContrato = $conDAO->NivelListaContratoFechados();
	                                    foreach ($arrayContrato as $conDAO => $c){
	                                    ?>
                                        <tr>
                                            <td><?php echo $c['id']; ?></td>
