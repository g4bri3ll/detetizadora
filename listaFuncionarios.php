    ...
    <div id="wrapper">
        ...
        <?php 
            if (!empty($_GET['exc'])){
            	...
            	$res = $usuDAO->deleteId($id, $status);
            	
				if ($res){
					?> <script type="text/javascript"> window.location="listaFuncionarios.php";  </script> <?php
				} else {
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <?php foreach ($arrayUsu as $usuDAO => $valor){?>
                                    <tr class="gradeA">
                                        <td><?php echo $valor['id']; ?></td>
                                        <td><?php echo $valor['nome']; ?></td>
                                        <td><?php echo $valor['email']; ?></td>
                                        <td><?php echo $valor['endereco']; ?></td>
                                        <td><a href="VisualizaFuncionarios.php?visualizar=<?php echo $valor['id']; ?>"><i class="fa fa-check"></i></a></td>
                                        <td><a href="listaFuncionarios.php?exc=<?php echo $valor['id']; ?>"><i class="fa fa-times"></i></a></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
