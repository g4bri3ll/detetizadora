...
class UploadLogoMarca{
		
	function img($fotoLogo){
		...
		if (isset ( $fotoLogo )) {
			...
			$name = $fotoLogo['name']; // Atribui uma array com os nomes dos arquivos à variável
			
			$tmp_name = $fotoLogo ['tmp_name']; // Atribui uma array com os nomes temporários dos arquivos à variável
			
			$type = $fotoLogo["type"]; //tipo da foto
			
			$size = $fotoLogo["size"]; //Tamanho da foto
